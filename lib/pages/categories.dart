...
import 'package:fease/utils/destructive_prompt.dart';
...
class _CategoriesState extends State<Categories> {
  ...
  late TextEditingController _textContoroller;

  @override
  void initState() {
    _textContoroller = TextEditingController(text: '');
  ...
  void createCategory() {
    var newCategory = realm.write<Category>(
        () => realm.add(Category(_textContoroller.text, pickerColor.value)));
    setState(() {
